...
def main():
    ...
    if config.TEST.MODEL_FILE:
        ...
        # model_state_file = os.path.join('../','output',final_output_dir,
        #                                 'final_state.pth.tar')
    ...
    # Data loading code
    normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],  #   归一化 ``input[channel] = (input[channel] - mean[channel]) / std[channel]``
